...
ECHO DROP DATABASE AdventureWorksDW
sqlcmd -S %_instancename% -E -Q "IF EXISTS(SELECT * FROM sys.databases WHERE [name] = 'AdventureWorksDW') BEGIN EXECUTE (N'ALTER DATABASE [AdventureWorksDW] SET SINGLE_USER WITH ROLLBACK IMMEDIATE;'); EXECUTE (N'DROP DATABASE [AdventureWorksDW];'); END"
