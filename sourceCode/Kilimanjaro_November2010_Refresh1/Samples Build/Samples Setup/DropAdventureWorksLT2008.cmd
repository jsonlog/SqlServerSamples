...
ECHO DROP DATABASE AdventureWorksLT2008
sqlcmd -S %_instancename% -E -Q "IF EXISTS(SELECT * FROM sys.databases WHERE [name] = 'AdventureWorksLT2008') BEGIN EXECUTE (N'ALTER DATABASE [AdventureWorksLT2008] SET SINGLE_USER WITH ROLLBACK IMMEDIATE;'); EXECUTE (N'DROP DATABASE [AdventureWorksLT2008];'); END"
