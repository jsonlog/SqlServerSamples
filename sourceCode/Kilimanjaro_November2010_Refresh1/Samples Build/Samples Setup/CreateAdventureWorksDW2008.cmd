...
sqlcmd -E -S %_instancename% -d master -i "%_sourcepath%AdventureWorks 2008 Data Warehouse\instawdwdb.sql" -b -v SqlSamplesSourceDataPath = "%_sourcepath%" -v SqlSamplesDatabasePath = "%_datapath%"
