...
sqlcmd -E -S %_instancename% -d master -i "%_sourcepath%AdventureWorks 2008 LT\instawltdb.sql" -b -v SqlSamplesSourceDataPath = "%_sourcepath%" -v SqlSamplesDatabasePath = "%_datapath%"
