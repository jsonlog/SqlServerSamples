...
ECHO DROP DATABASE AdventureWorks2008
sqlcmd -S %_instancename% -E -Q "IF EXISTS(SELECT * FROM sys.databases WHERE [name] = 'AdventureWorks2008') BEGIN EXECUTE (N'ALTER DATABASE [AdventureWorks2008] SET SINGLE_USER WITH ROLLBACK IMMEDIATE;'); EXECUTE (N'DROP DATABASE [AdventureWorks2008];'); END"
