...
ECHO DROP DATABASE AdventureWorksDW2008
sqlcmd -S %_instancename% -E -Q "IF EXISTS(SELECT * FROM sys.databases WHERE [name] = 'AdventureWorksDW2008') BEGIN EXECUTE (N'ALTER DATABASE [AdventureWorksDW2008] SET SINGLE_USER WITH ROLLBACK IMMEDIATE;'); EXECUTE (N'DROP DATABASE [AdventureWorksDW2008];'); END"
