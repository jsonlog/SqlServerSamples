...
ECHO DROP DATABASE AdventureWorks
sqlcmd -S %_instancename% -E -Q "IF EXISTS(SELECT * FROM sys.databases WHERE [name] = 'AdventureWorks') BEGIN EXECUTE (N'ALTER DATABASE [AdventureWorks] SET SINGLE_USER WITH ROLLBACK IMMEDIATE;'); EXECUTE (N'DROP DATABASE [AdventureWorks];'); END"
