...
ECHO.
ECHO Dropping AW OLAP databases.
...
"%_sourcepath%ascmd.exe" -S "%_instancename%" -i "%_sourcepath%AdventureWorks Analysis Services Project\enterprise\Adventure Works DW Script Delete.xmla"

ECHO Drop the standard version of the cube.
"%_sourcepath%ascmd.exe" -S "%_instancename%" -i "%_sourcepath%AdventureWorks Analysis Services Project\standard\Adventure Works DW Standard Edition Script Delete.xmla"
...
ECHO.
ECHO       DropAdventureWorksOLAP.cmd "." "C:\Program Files\Microsoft SQL Server\100\Tools\Samples\"
ECHO.
